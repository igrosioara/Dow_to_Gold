...
const sourceData = {
  ...
  weeklyDates: [
	...
	"03/27/26", "04/02/26", "04/10/26", "04/17/26"
],
  dailyDates: [
   	"01/26/26",
  ...
  goldWeeklyValue: [
	...
	4493.12, 4676.86, 4746.90, 4837.49
  ],
  silverWeeklyValue: [
  ...
  platinumWeeklyValue: [
	...
	1858.85, 1994.50, 2045.96, 2100.60
  ],
  palladiumWeeklyValue: [
	...
	1379.49, 1509.00, 1521.28, 1558.00
  ],
  djiaWeeklyValue: [
...
// Charts Title
const MONTHLY_CURRENT_DATE = "March 2026";
const WEEKLY_CURRENT_DATE = "April 17, 2026";
const DAILY_CURRENT_DATE = "April 17, 2026";
